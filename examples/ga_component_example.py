...
from ecspy.contrib.variator_pipe import n_point_crossover, n_point_crossover, iterate_rate, iterate_rate, recombine_candidates, recombine_candidates, bit_flip_mutation, mutate_candidates, mutate_candidates
...
def main(prng=None): 
    ...
    crossover = recombine_candidates(2, n_point_crossover(2))
    mutation = mutate_candidates(iterate_rate(0.1, bit_flip_mutation()))                                                     

    ga.variator = [crossover, mutation]
